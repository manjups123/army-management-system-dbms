...
public class VIEWT {
	...
	private void initialize() {
		...
		String[] columns = new String[] { "Soldier_id", "Type", "Regiment Name", "Duration" };
		...
		btnView.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					String query = "select count(*)" + "from traininf_info";
					...
					String sql = "select so_id,type,r_name , duration " + "from traininf_info";
		...
		btnView.setBounds(405, 82, 173, 35);
		...
		lblNewLabel.setBounds(-10, -130, 1750, 1100);
