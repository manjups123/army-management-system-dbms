...
public class VIEWW {
	...
	private void initialize() {
		...
		String[] columns = new String[] { "Soldier_id", "Weapon ID", "Weapon Name" };
		...
		btnView.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					String query = "select count(*)" + "from weapon_info";
					...
					String sql = "select sr_id ,wp_id ,wp_name " + "from weapon_info";
		...
		btnView.setBounds(413, 82, 172, 35);
