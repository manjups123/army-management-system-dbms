...
public class VIEWAW {
	...
	private void initialize() {
		...
		String[] columns = new String[] { "Soldier_id", "AWARD Name" };
		...
		btnView.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					String query = "select count(*)" + "from awards_info";
					...
					String sql = "select sd_id , award_name " + "from awards_info";
		...
		btnView.setBounds(412, 82, 169, 35);
